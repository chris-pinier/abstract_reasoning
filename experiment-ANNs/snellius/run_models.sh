...
#SBATCH --output=slurm_output/SLURM-%j-run_models.out # Default output (will be overridden); %j will be replaced by the job id
#SBATCH --error=slurm_output/SLURM-%j-run_models.err  # Default error (will be overridden); %j will be replaced by the job id
...
python run_models.py --model_id "$model_id"