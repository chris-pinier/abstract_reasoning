"""Legacy monolithic human data loader.

New code should prefer the split modules in ``ar_analysis.data_loader.human``.
This file is kept for backwards compatibility with existing analyses and
notebooks that import ``HumanSessData``, ``HumanSubjData``, or
``HumanGroupData`` from ``ar_analysis.data_loader.human_data``.
"""
