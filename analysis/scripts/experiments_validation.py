...
def main():
    ...
    for subj_i, (subj_label, datasets_by_level) in enumerate(
        ...
        for level, match_descriptor in RSA_LEVELS.items():
            ...
            rsa_results[level][subj_label], matched_counts[level][subj_label] = (
                subject_rsa(datasets, match_descriptor=match_descriptor)
            )
